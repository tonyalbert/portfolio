<template>
    <div :style="{ 'border-bottom': bdColor }" class="bg-[#212121] rounded-md group flex flex-col p-4 items-center justify-center border-b-4 border-[#0385D2] hover:bg-white transition cursor-pointer">
